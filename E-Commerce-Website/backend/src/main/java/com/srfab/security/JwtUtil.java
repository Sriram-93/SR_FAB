...
public class JwtUtil {
    ...
    public Boolean validateToken(String token, String email) {
        ...
        boolean usernameMatches = username.equals(email);
        boolean isExpired = isTokenExpired(token);
        if (!usernameMatches) System.out.println("JWT Validation Failed: Username mismatch. Token: " + username + ", User: " + email);
        if (isExpired) System.out.println("JWT Validation Failed: Token expired.");
