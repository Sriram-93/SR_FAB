    ...
    <div className="-mx-4 sm:-mx-6 lg:-mx-8">
      ...
      <section className="py-20 bg-primary text-white">
        <div className="mx-auto max-w-4xl px-6 text-center">
          <h2 className="font-serif text-3xl font-bold sm:text-4xl">Join Our Newsletter</h2>
          <p className="mt-4 text-gray-300">Subscribe to get special offers, free giveaways, and once-in-a-lifetime deals.</p>
          <form onSubmit={handleSubscribe} className="mt-8 flex flex-col gap-4 sm:flex-row sm:justify-center">
            <input name="email" type="email" placeholder="Enter your email" className="w-full rounded bg-white/10 px-4 py-3 text-white placeholder-gray-400 outline-none ring-1 ring-white/20 focus:ring-accent sm:w-80" required />
            <button type="submit" className="bg-accent px-8 py-3 font-bold uppercase tracking-widest text-white transition hover:bg-white hover:text-primary">Subscribe</button>
          </form>
        </div>
      </section>
